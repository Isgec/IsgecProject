...
function OffSetForGrid1(activeid, divid, listboxid, griddivid) {
    jq('#' + listboxid).empty();
    document.getElementById(divid).style.top = jq("#" + activeid).position().top + 180 + "px";
    document.getElementById(divid).style.left = "121px";;//jq("#" + activeid).position().left + "121px";
    jq('#' + divid).show("slow");
    document.getElementById(listboxid).focus();
}
...
function OffSetForGridpolist(activeid, divid, listboxid, griddivid) {
    jq('#' + listboxid).empty();
    document.getElementById(divid).style.top = jq("#" + activeid).position().top + 275 + "px";
    document.getElementById(divid).style.left = jq("#" + activeid).position().left +220+ "px";
    jq('#' + divid).show("slow");
    document.getElementById(listboxid).focus();
}