...
function tabvalue(event) {
    ...
    if (key == 113) {
        ...
        if (document.activeElement.id == "protxtreceiptno") {
            ...
            if (UNIT == "0") {
                UNIT = document.getElementById('hdnloginbranch').value;
            }
            var prorec = document.getElementById('protxtreceiptno').value.toUpperCase();
            ReceiptEntry.bindprovrec(document.getElementById('hiddencompcode').value, doctype, pay_reason, UNIT, prorec, document.getElementById('hiddenuserid').value, document.getElementById('hdnunitcd').value, bindprov_callback);
        ...
        if (document.activeElement.id.indexOf("aglist") >= 0) {
            ...
            if ((AG_MAIN_CODE + AG_SUB_CODE) == "CO1249COM161") {
                document.getElementById('txtagency').value = "";
...
function insertagency(event) {
    ...
    if (key == 13 || event.type == "click") {
        ...
        if (document.activeElement.id == "lstagency") {
            ...
            document.getElementById('hdnreceipt_alw').value = receiptalw;
            document.getElementById('txtagency').focus();
            chbankdt(document.getElementById('drppaymode').value);
            ...
            var UNIT = split[28];
            var receiptallow = split[29];
            var prtamt = split[30];
            var MULTITIMES_PROVRCPT_REQ = split[31];
            var cashfrt = split[32];
            var REVENUE_CDS_FLAG = split[33];
            var CASHBANK_CDS_FLAG = split[34];
            var branchname = split[35];
            var adtypenm = split[36];
            var adtype = split[37];
            ...
            //if (jq("#drptype").val() != "MJD") {
                document.getElementById('hdn_creditsub_ledger').value = REVENUE_CDS_FLAG;
                document.getElementById('hdn_sub_ledger').value = CASHBANK_CDS_FLAG;
                ...
                document.getElementById('hdnchequeno').value = CHNO;//txtchno
                document.getElementById('hdnchequedt').value = CHDT;//txtchdate
                ...
                document.getElementById('hdnprtno').value = manualrepno;//txtmanrecptno
                document.getElementById('hdnprtdt').value = manualrepdt;//txtmanrecptdt
                document.getElementById('txtbankbranch').value = CHQBANK_BRANCH;
                document.getElementById('drpunit').value = UNIT;
                document.getElementById('txtbranch').value = branchname;
                document.getElementById('hdnprtamt').value = prtamt;
                document.getElementById('hdnmultiprovrecreq').value = MULTITIMES_PROVRCPT_REQ;
                document.getElementById('hdncashfrt').value = cashfrt;
                document.getElementById('txtadtype').value = adtypenm;
                document.getElementById('hdnadtype').value = adtype;

                if (document.getElementById('hdncashfrt').value == "Y") {

                    document.getElementById('txtmanrecptno').value = manualrepno;//txtmanrecptno
                    document.getElementById('txtmanrecptdt').value = manualrepdt;//txtmanrecptdt
                    document.getElementById('hdnprtno').value = manualrepno;//txtmanrecptno
                    document.getElementById('hdnprtdt').value = manualrepdt;//txtmanrecptdt
                    document.getElementById('txtprtamt').value = prtamt;
                    document.getElementById('hdnprtamt').value = prtamt;
                }
                else {
                    document.getElementById('hdnprtno').value = manualrepno;//txtmanrecptno
                    document.getElementById('hdnprtdt').value = manualrepdt;//txtmanrecptdt
                    document.getElementById('txtmanrecptno').value = "";//txtmanrecptno
                    document.getElementById('txtmanrecptdt').value = "";
                    document.getElementById('txtprtamt').value = "";
                    document.getElementById('hdnprtamt').value = prtamt;
                }
                ...
                if (document.getElementById('hdncashfrt').value == "Y") {
                    document.getElementById('txtDate').value = document.getElementById('txtprovoucherdate').value;
                }
                else {
                    //document.getElementById('txtDate').value = "";
                }

                document.getElementById('hdninwardentryflag').value = "Y";
...
function disabllfield() {
    if (document.getElementById('protxtreceiptno').value == "") {
        ...
        document.getElementById('txtdepositdate').disabled = false;
        document.getElementById('hdncashfrt').value = "N";
    }
    else {
        if ((document.getElementById('txtagcode').value + document.getElementById('txtagsubcode').value) == "CO1249COM161") {
            document.getElementById('txtagency').disabled = false;
            document.getElementById('txtagency').value = "";
        ...
        if (document.getElementById('hdnmultiprovrecreq').value == "Y") {
            document.getElementById('txtamount').disabled = false;
        }
        else {
            document.getElementById('txtamount').disabled = true;
        }
            document.getElementById('txtdepositdate').disabled = true;
    }
