...
function loadMap() 
{
  ...
  // Palo Alto, CA
  map.setCenter(new GLatLng(28.632897,77.219639), 12);
...
ContextMenuControl.prototype.createContextMenu_ = function (change) {
  ...
  if (me.options.whatsHere !== false) {
    me.menuList.appendChild(me.createListItem_("Get a Location", "here"));
  }
  me.hideMenu_();
...
var createhtml=""
  ...
  for (var m = 0; m < numRoutes; m++) {
    ...
    for (var n = 0; n < numSteps; n++) {
      ...
      var print_step=step.g.descriptionHtml.replace("<b>","").replace("</b>","")
      var distance=step.g.Distance.meters+"mt.";
      var duration=step.g.Duration.seconds+"sec.";
      var coordinates=step.g.Point.coordinates[0]+","+step.g.Point.coordinates[1];
      point=step.Za;
////////////
getAddress("", point)
...
//////    document.getElementById('Td_supply_final').style.display='block';
//////   
//////    createhtml+="<table Width='740px' style='border:1px solid black ' >"
//////    createhtml+="<tr><td bgcolor=#7DAAE3 style='font-size:10px;font-weight:bold;text-align:center;border:1px solid #7DAAE3;'></td><td>"
//////    createhtml+="Direction: "+print_step+"<br>"
//////    createhtml+="Distance: "+distance+"<br>"
//////    createhtml+="Address: "+address1+"<br>"
////// 
//////    //createhtml+="Co-ordinates: "+coordinates
//////    createhtml+="</td></tr>"
//////    createhtml+="</table>"
    //document.getElementById("Td_supply_final").innerHTML=createhtml
