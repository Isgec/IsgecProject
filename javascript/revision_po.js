...
function clearclick() {
    //jq('#txtpo,#txtsupcode,#txtrreason,#txterpno,#txtstatus,#txtisgecgstin,#txtquationno,#txtqudt,#txtaprvdt,#txtcrtdby,#txtpymntterm,#txtcrtdon,#txtdelveryon,#txtsentaprv,#txtdispacth,#txtaprvon,#txtdes,#txtaprovedby,#txtinsurance,#txtaprovedon,#txtreject,#drpcurrency,#txtconvervisonfactor,#txtsupname').prop("disabled", true);
    //jq('#txtpo,#txtsupcode,#txtrreason,#txtgstin,#txtstatus,#txtquationno,#txtqudt,#txtaprvdt,#txtpymntterm,#txtdelveryon,#txtsentaprv,#txtdispacth,#txtaprvon,#txtdes,#txtaprovedby,#txtinsurance,#txtaprovedon,#txtremrks,#txtconvervisonfactor,#txtsupname').val('');
...
function EnabledOnQuery() {
    ...
    jq('#txtpo,#txtsupcode,#txtrreason,#txtreject,#txterpno,#txtstatus,#txtquationno,#txtqudt,#txtaprvdt,#txtcrtdby,#txtpymntterm,#txtcrtdon,#txtdelveryon,#txtsentaprv,#txtdispacth,#txtaprvon,#txtdes,#txtaprovedby,#txtinsurance,#txtaprovedon,#txtremrks').prop("disabled", false);
    jq('#txtsupcode,#txtrreason,#txtgstin,#txtreject,#txtstatus,#txtquationno,#txtqudt,#txtaprvdt,#txtpymntterm,#txtdelveryon,#txtsentaprv,#txtdispacth,#txtaprvon,#txtdes,#txtaprovedby,#txtinsurance,#txtaprovedon,#txtremrks').val('');
...
function BindGridHeader() {
    ...
    hdsview += ("<td class='Divpadding_left th' style='Width:3%;'>Tax Code<FONT color=red>*</FONT></td>")
...
function savedata(flag) {
    ...
    if (confirm("Are you sure you want to revision of this PO.?") == true) {
        var modi = flag;
        ...
        var res_vch33 = revision_po.hdr_saverevision(PPONo, PPoDate, PRevisionNo, Pstatus, PQuatationNo, PQuotationDate, PBPCode, PBPGSTIN, PERPCompany,
        ...
        flag, pextra1, pextra2, pextra3, pextra4, pextra5, connstring);
        if (res_vch33.error != null) {
            ...
            //for final revision//
            pextra2 = "";
            var res_vch2 = revision_po.hdr_saverevision(PPONo, PPoDate, PRevisionNo, Pstatus, PQuatationNo, PQuotationDate, PBPCode, PBPGSTIN, PERPCompany,
            PIsgecGSTIN, PPaymentTerm, PDeliveryTerm, PModeofDispatch, PDestination, PInsurance, PRemarks, PApproverType, PCreatedby,
            PCreatedOn, PSentforapprovalBy, PSentforApprovalon, PApprovedBy, PApprovedOn, PReasonofRevision, PApproval_RejectionRemarks,
            flag, pextra1, pextra2, pextra3, pextra4, pextra5, connstring);
            if (res_vch2.error != null) {
                ...
                alert(res_vch2.value.Tables[0].Rows[0].MSG)
...
function bindbilltypecodef2(event) {
    ...
    if (event.keyCode == 113) {
        ...
        var connstring = document.getElementById("hdnconnectionstring").value;
        var res = revision_po.Bindbilltypecode(connstring, BindBillTypeCdCallbackgrid);
        return false;
    }
...
function bindhsnsaccodef2(event) {
    ...
    if (event.keyCode == 113) {
        ...
        var res = revision_po.Bindhsnsaccode(billtype, hsnsaccd, extra1, extra2, extra3, extra4, extra5, connstring, BindHsnCdCallbackgrid);
        return false;
    }
    else if (keycode == 8 || keycode == 46) {
...
function bindemployeef2(event) {
    ...
    if (event.keyCode == 113) {
        ...
        var hsnsaccd = document.getElementById(CurrentTextId).value;
        var extra1 = "", extra2 = "", extra3 = "", extra4 = "", extra5 = "";
        var res = revision_po.Bindemployeecode(hsnsaccd, extra1, extra2, extra3, extra4, extra5, connstring, BindEmployeeCdCallbackgrid);
        return false;
    }
    else if (keycode == 8 || keycode == 46) {
...
function binddepartmentidf2(event) {
    ...
    if (event.keyCode == 113) {
        ...
        var extra1 = "", extra2 = "", extra3 = "", extra4 = "", extra5 = "";
        var res = revision_po.Binddepatmentcode(department, extra1, extra2, extra3, extra4, extra5, connstring, BindDepartmentCdCallbackgrid);
        return false;
    }
    else if (keycode == 8 || keycode == 46) {
...
function bindcostcenteridf2(event) {
    ...
    if (event.keyCode == 113) {
        ...
        var extra1 = "", extra2 = "", extra3 = "", extra4 = "", extra5 = "";
        var res = revision_po.Bindcostcentercode(costcenter, extra1, extra2, extra3, extra4, extra5, connstring, BindcostcenCdCallbackgrid);
        return false;
    }
    else if (keycode == 8 || keycode == 46) {
...
function bindtaxtypecodef2(event) {
    ...
    if (event.keyCode == 113) {
        ...
        var connstring = document.getElementById("hdnconnectionstring").value;
        var res = revision_po.BindTaxtype(jq('#' + CurrentTextId).val().toUpperCase(), "", "", "", "", "", connstring, BindTaxtypcdCallbackgrid);
        return false;
    }
    else if (keycode == 8 || keycode == 46) {
...
function filltaxtypecode(event) {
    ...
    if (keycode == 13 || event.type == "click") {
        ...
        var connstring = document.getElementById("hdnconnectionstring").value;
        var res = revision_po.BindTaxratetype("", str[0], "", "", "", "", "", connstring);
...
function binditemcodef2(event) {
    ...
    if (event.keyCode == 113) {
        ...
        var connstring = document.getElementById("hdnconnectionstring").value;
        var res = revision_po.Binditemcode(jq('#' + CurrentTextId).val().toUpperCase(), "", "", "", "", "", connstring, BinditemcdCallbackgrid);
        return false;
    }
    else if (keycode == 8 || keycode == 46) {
...
function bindsupliercodef2(event) {
    ...
    if (event.keyCode == 113) {
        ...
        if (jq("#txtsupcode").val() == "") {
            var res = revision_po.Bindsuppcode(jq('#' + CurrentTextId).val().toUpperCase(), "", "", "", "", "", connstring, BindsupliercdCallbackgrid);
        }
        else {
            var res = revision_po.Bindsuppcode(jq('#' + CurrentTextId).val().toUpperCase(), jq("#txtsupcode").val(), "", "", "", "", connstring, BindsupliercdCallbackgrid);
        }
        return false;
    }
    else if (keycode == 8 || keycode == 46) {
...
function EnableExecute() {
    ...
    try {
        ...
        var connstring = document.getElementById("hdnconnectionstring").value;
        var res_vch2 = revision_po.hdr_save(PPONo, PPoDate, PRevisionNo, Pstatus, PQuatationNo, PQuotationDate, PBPCode, PBPGSTIN, PERPCompany,
        PIsgecGSTIN, PPaymentTerm, PDeliveryTerm, PModeofDispatch, PDestination, PInsurance, PRemarks, PApproverType, PCreatedby,
        PCreatedOn, PSentforapprovalBy, PSentforApprovalon, PApprovedBy, PApprovedOn, PReasonofRevision, PApproval_RejectionRemarks,
    ...
    if (res_vch2.error != null) {
        ...
        if (exec_data.Tables[0].Rows.length == 0) {
            ...
            jq('#btnNew,#btnExecute').prop("disabled", true);
            jq('#btnCancel,#btnExit,#btnlast,#btnSave,#btnfirst,#btnDelete,#btnprevious,#btnnext,#btnDelete').prop("disabled", false);
            jq('#txtsupcode,#txtreject,#txterpno,#txtstatus,#txtisgecgstin,#txtquationno,#txtqudt,#txtaprvdt,#txtcrtdby,#txtpymntterm,#txtcrtdon,#txtdelveryon,#txtsentaprv,#txtdispacth,#txtaprvon,#txtdes,#txtaprovedby,#txtinsurance,#txtaprovedon,#txtremrks').prop("disabled", true);
            executehdr();
            setButtonImages();
...
function BindBudgetAccountDetail1(typecd) {
    ...
    var costcenter = "";
    var connstring = document.getElementById("hdnconnectionstring").value;
    var res_vch2 = revision_po.hdr_savedet(PPONo, rivision_no, line_no, Item_Code, Quantity, Unit, currency, Price_per_unit, Assessable_Value, Tax_Code, SGST_rate, CGST_rate,
    ...
    if (res_vch2.error != null) {
        ...
        try {
            ...
            for (count1 = 0; count1 < dsmain1.Tables[0].Rows.length; count1++) {
                ...
                hdsview += ("<tr>")
                hdsview += "<td><input  name='Disable' class='gridinputclassnew' style='text-align:left; background-color:#C0C0C0;' id=txtpoline_" + count1 + " value='" + fndnull(dsmain1.Tables[0].Rows[count1].POLine) + "'></td>"
                hdsview += "<td><input  name='Disable' class='gridinputclassnew' style='text-align:left; background-color:#C0C0C0;' id=txtitemcode_" + count1 + "  value='" + fndnull(dsmain1.Tables[0].Rows[count1].itemdescription) + "' onkeydown='return binditemcodef2(event);' ></td>"
                hdsview += "<td><input  name='Disable' class='gridinputclassnew' style='text-align:left; background-color:#C0C0C0;' id=txtqty_" + count1 + "   value='" + fndnull(dsmain1.Tables[0].Rows[count1].Quantity) + "'></td>"
                hdsview += "<td><input  name='Disable' class='gridinputclassnew' style='text-align:left; background-color:#C0C0C0;' id=txtuom_" + count1 + "  value='" + fndnull(dsmain1.Tables[0].Rows[count1].Unit) + "'  ></td>"
                hdsview += "<td><input  name='Disable' class='gridinputclassnew' style='text-align:left; background-color:#C0C0C0;' id=txtpricperunit_" + count1 + " value='" + fndnull(dsmain1.Tables[0].Rows[count1].Price) + "' onblur='autocalcamt(this.id,this.value,event)'></td>"
                hdsview += "<td><input  name='Disable' class='gridinputclassnew' style='text-align:left; background-color:#C0C0C0;' id=txtaccessbleval_" + count1 + "  value='" + fndnull(dsmain1.Tables[0].Rows[count1].AssessableValue) + "'   ></td>"
                hdsview += "<td><input  name='Enable'  class='gridinputclassnew' style='text-align:left; background-color:#C0C0C0;' id=txttaxcode_" + count1 + " value='" + fndnull(dsmain1.Tables[0].Rows[count1].taxcddescription) + "'  onkeydown='return bindtaxtypecodef2(event);' ></td>"
                hdsview += "<td><input  name='Enable'  class='gridinputclassnew' style='text-align:left; background-color:#C0C0C0;' id=txtbilltype_" + count1 + " value='" + fndnull(dsmain1.Tables[0].Rows[count1].Bill_TypeName) + "'  onkeydown='return bindbilltypecodef2(event);' ></td>"
                hdsview += "<td><input  name='Enable'  class='gridinputclassnew' style='text-align:left; background-color:#C0C0C0;' id=txthsnsac_" + count1 + " value='" + fndnull(dsmain1.Tables[0].Rows[count1].hsncodename) + "'  onkeydown='return bindhsnsaccodef2(event);' ></td>"
                hdsview += "<td><input  name='Disable' class='gridinputclassnew' style='text-align:left; background-color:#C0C0C0;' id=txtsgstrate_" + count1 + "  value='" + fndnull(dsmain1.Tables[0].Rows[count1].SGSTrate) + "'   ></td>"
                hdsview += "<td><input  name='Disable' class='gridinputclassnew' style='text-align:left; background-color:#C0C0C0;' id=txtcgstrate_" + count1 + " value='" + fndnull(dsmain1.Tables[0].Rows[count1].CGSTrate) + "'></td>"
                hdsview += "<td><input  name='Disable' class='gridinputclassnew' style='text-align:left; background-color:#C0C0C0;' id=txtigstrate_" + count1 + "  value='" + fndnull(dsmain1.Tables[0].Rows[count1].IGSTrate) + "'   ></td>"
                hdsview += "<td><input  name='Disable' class='gridinputclassnew' style='text-align:left; background-color:#C0C0C0;' id=txtcessrate_" + count1 + " value='" + fndnull(dsmain1.Tables[0].Rows[count1].CESSrate) + "'></td>"
                hdsview += "<td><input  name='Disable' class='gridinputclassnew' style='text-align:left; background-color:#C0C0C0;' id=txttcsrate_" + count1 + " value='" + fndnull(dsmain1.Tables[0].Rows[count1].TCSrate) + "'  ></td>"
                hdsview += "<td><input  name='Disable' class='gridinputclassnew' style='text-align:left; background-color:#C0C0C0;' id=txtsgstamt_" + count1 + " value='" + fndnull(dsmain1.Tables[0].Rows[count1].SGSTAmount) + "'></td>"
                hdsview += "<td><input  name='Disable' class='gridinputclassnew' style='text-align:left; background-color:#C0C0C0;' id=txtcgstamt_" + count1 + "  value='" + fndnull(dsmain1.Tables[0].Rows[count1].CGSTAmount) + "'   ></td>"
                hdsview += "<td><input  name='Disable' class='gridinputclassnew' style='text-align:left; background-color:#C0C0C0;' id=txtigstamt_" + count1 + " value='" + fndnull(dsmain1.Tables[0].Rows[count1].IGSTAmount) + "'></td>"
                hdsview += "<td><input  name='Disable' class='gridinputclassnew' style='text-align:left; background-color:#C0C0C0;' id=txtcessamt_" + count1 + " value='" + fndnull(dsmain1.Tables[0].Rows[count1].CESSAmount) + "'  ></td>"
                hdsview += "<td><input  name='Disable' class='gridinputclassnew' style='text-align:left; background-color:#C0C0C0;' id=txttcsamt_" + count1 + " value='" + fndnull(dsmain1.Tables[0].Rows[count1].TCSAmount) + "'></td>"
                hdsview += "<td><input  name='Enable'  class='gridinputclassnew' style='text-align:left; background-color:#C0C0C0;' id=txtemployee_" + count1 + " value='" + fndnull(dsmain1.Tables[0].Rows[count1].emp_Name) + "'  onkeydown='return bindemployeef2(event);' ></td>"
                hdsview += "<td><input  name='Enable'  class='gridinputclassnew' style='text-align:left; background-color:#C0C0C0;' id=txtdepartment_" + count1 + " value='" + fndnull(dsmain1.Tables[0].Rows[count1].depart_Name) + "'  onkeydown='return binddepartmentidf2(event);' ></td>"
                hdsview += "<td><input  name='Enable'  class='gridinputclassnew' style='text-align:left; background-color:#C0C0C0;' id=txtcostcenter_" + count1 + " value='" + fndnull(dsmain1.Tables[0].Rows[count1].costcenter_Name) + "'  onkeydown='return bindcostcenteridf2(event);' ></td>"
                hdsview += "<td style='display:none;'><input type = 'text' class='class_disabled1' style='font-size:small;color:black;cursor:pointer;vertical-align:top; padding-right:2px; text-align:left;width:100%; text-transform: uppercase;' id=hdntaxtyocdcdgrid_" + count1 + "  value='" + fndnull(dsmain1.Tables[0].Rows[count1].TaxCode) + "'    disabled></td>";
                hdsview += "<td style='display:none;'><input type = 'text' class='class_disabled1' style='font-size:small;color:black;cursor:pointer;vertical-align:top; padding-right:2px; text-align:left;width:100%; text-transform: uppercase;' id=hdnrategrid_" + count1 + "        value=''     disabled></td>";
                hdsview += "<td style='display:none;'><input type = 'text' class='class_disabled1' style='font-size:small;color:black;cursor:pointer;vertical-align:top; padding-right:2px; text-align:left;width:100%; text-transform: uppercase;' id=hdnitemcdgrid_" + count1 + "      value='" + fndnull(dsmain1.Tables[0].Rows[count1].ItemCode) + "'   disabled></td>";
                hdsview += "<td style='display:none;'><input type = 'text' class='class_disabled1' style='font-size:small;color:black;cursor:pointer;vertical-align:top; padding-right:2px; text-align:left;width:100%; text-transform: uppercase;' id=hdnbilltypecdgrid_" + count1 + "   value='" + fndnull(dsmain1.Tables[0].Rows[count1].BillType) + "'   disabled></td>";
                hdsview += "<td style='display:none;'><input type = 'text' class='class_disabled1' style='font-size:small;color:black;cursor:pointer;vertical-align:top; padding-right:2px; text-align:left;width:100%; text-transform: uppercase;' id=hdnhsnsaccdgrid_" + count1 + "     value='" + fndnull(dsmain1.Tables[0].Rows[count1].HSNSACCode) + "'   disabled></td>";

                hdsview += "<td style='display:none;'><input type = 'text' class='class_disabled1' style='font-size:small;color:black;cursor:pointer;vertical-align:top; padding-right:2px; text-align:left;width:100%; text-transform: uppercase;' id=hdnemployeegrid_" + count1 + "     value='" + fndnull(dsmain1.Tables[0].Rows[count1].EmployeeID) + "'   disabled></td>";
                hdsview += "<td style='display:none;'><input type = 'text' class='class_disabled1' style='font-size:small;color:black;cursor:pointer;vertical-align:top; padding-right:2px; text-align:left;width:100%; text-transform: uppercase;' id=hdndepartmentgrid_" + count1 + "   value='" + fndnull(dsmain1.Tables[0].Rows[count1].DepartmentID) + "'   disabled></td>";
                hdsview += "<td style='display:none;'><input type = 'text' class='class_disabled1' style='font-size:small;color:black;cursor:pointer;vertical-align:top; padding-right:2px; text-align:left;width:100%; text-transform: uppercase;' id=hdncostcentergrid_" + count1 + "   value='" + fndnull(dsmain1.Tables[0].Rows[count1].CostCenterID) + "'   disabled></td>";
...
function bindsuplierisgcode(event) {
    ...
    if (event.keyCode == 113) {
        ...
        var connstring = document.getElementById("hdnconnectionstring").value;
        var res = revision_po.Bindsupisgccode(jq('#' + CurrentTextId).val().toUpperCase(), "", "", "", "", "", connstring, BindsuplierisgcodeCallbackgrid);
        return false;
    }
    else if (keycode == 8 || keycode == 46) {
