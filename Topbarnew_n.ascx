...
<script type="text/javascript" src="javascript/TreeLibrary.js"></script>
<script type="text/javascript">

</script>
<div class="n_topbar">
	<%--<div  class="n_logo"><img id="imglogo" runat="server" src="images/udyavani-logo.jpg" width="206" height="68" /></div>--%>
    <legend class="legend" style="color: #00008B; font-family: Arial; font-size: 16px; font-weight: bold; WIDTH: 200PX; PADDING-LEFT: 3PX;" id="ligencd1" runat="server"></legend>
...
<input id="hiddendatetime" runat="server" type="hidden" name="hiddendatetime" />
