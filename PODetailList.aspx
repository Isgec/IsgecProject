<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PODetailList.aspx.cs" Inherits="PODetailList" EnableEventValidation="true"%>
<!DOCTYPE html>
...
<div class="content">
                   ...
                   <div class="control-group">
                       <div class="container-fluid mt-3">
                           ...
                           <div class="row" id="Div4">
                               ...
                               <div class="col-sm-3">
                                   <div class="form-group">
                                       <input type="text" class="form-control txtboxstyle" id="textrevisionno" onchange="bindgriddetail();"   placeholder="" name="Order" runat="server" />
                           ...
                           <div class="row" id="Div1">
                               <div class="col-sm-2">
                                   <div class="form-group">
                                       <label for="Order no" id="Label2" runat="server">Supplier Name</label>
                                   </div>
                               </div>
                               <div class="col-sm-3">
                                   <div class="form-group">
  ...
  <script type="text/javascript" src="javascript/PODetailList.js"></script>
</html>