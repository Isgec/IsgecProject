<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PurchasesOrder.aspx.cs" Inherits="PurchasesOrder" EnableEventValidation="false" %>
...
<body onload="javascript:return clearclick();" style="background-color: #f3f6fd; margin: 0px 0px 0px 0px">
    <form id="form1" runat="server">
        ...
        <table id="OuterTable" width="1000px" border="0" cellpadding="0" cellspacing="0">
            <tr valign="top">
                <td colspan="2">
                    <uc1:Topbar ID="Topbar1" runat="server" Text="Purchases Order"></uc1:Topbar>
                </td>
            </tr>
            <tr>
                        ...
                        <div class="row" id="Div8" style="margin-left: 0px;">
                            ...
                            <div class="col-sm-3">
                             ...
                             <div class="col-sm-1"></div>
                              ...
                              <div class="col-sm-3" style="padding-right: 0px;">
                                <div class="form-group">
                                    <asp:Label ID="lblwarrentyrmk" runat="server" CssClass="lbtxt"></asp:Label>
                                </div>
                            </div>
                            <div class="col-sm-3">
                                <div class="form-group">
                                    <asp:TextBox ID="txtwarrentyrmk" runat="server" CssClass="TextFieldNew" Style="width: 100%;"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                    </fieldset>
        ...
        <div class="col-sm-12">
            <fieldset style="width: 100%; float: left; margin-top: 10px; border: 2px solid #094A9C; padding: 0px 10px 0px 0px; height: auto;">
                ...
                <div style="width: 107%; padding-left: 1068px; padding-top: 204px;">
                    <input type="button" runat="server" id="btnsentfrapproval" value="Sent For Approval"  onclick="javascript: return forsentapp();"
                        style="width: 115px; height: 22px; text-align: center; font-size: 11px; font-family: Verdana; background-color: #7daae3" />
                    <input type="button" runat="server" id="btnapproval" value="Approve" onclick="javascript: return Approve();"
                        style="width: 70px; height: 22px; text-align: center; font-size: 11px; font-family: Verdana; background-color: #7daae3;" />
                     <input type="button" runat="server" id="btnreject" value="Reject" onclick="javascript: return Reject();"
                        style="width: 70px; height: 22px; text-align: center; font-size: 11px; font-family: Verdana; background-color: #7daae3" />
                </div>
    ...
    <script type="text/javascript" src="javascript/PurchasesOrder.js"></script>
