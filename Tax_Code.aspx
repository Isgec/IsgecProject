<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Tax_Code.aspx.cs" Inherits="Tax_Code" %>
...
<head id="Head1" runat="server">
    <title>Tax Type Code Master</title>
...
<body  style="background-color: #f3f6fd; margin: 0px 0px 0px 0px" onload="javascript:return clearclick();">
    ...
    <div>
        ...
        <div id="taxcodemaster" style="width: 50%; position: absolute; height: auto;
            ...
            <fieldset id="DivItemDetail" style="width: 50%; border-style: double; border-width: 2px;
                ...
                <div style="width: 90%;">
                    <input type="button" runat="server" id="BtnAddRow" value="Add Row" onclick="javascript: return CommonCreateRow('Tax_Code1');"
                        style="width: 70px; height: 22px; text-align: center; font-size: 11px; font-family: Verdana;" />
                    <input type="button" runat="server" id="btncancle" value="exit" onclick="javascript: return ChqbouGridClose('Tax_Code1');"
