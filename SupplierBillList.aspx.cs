...
public partial class SupplierBillList : System.Web.UI.Page
{
    int j = 1;
    int i = 0;
    int sno = 1;
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        Ajax.Utility.RegisterTypeForAjax(typeof(SupplierBillList));
        if (!Page.IsPostBack)
        {
    ...
    [Ajax.AjaxMethod]
    public DataSet hdr_savedet(string PPONo, string irno, string BillNumber, string BillDate, string BPID, string pextra1, string pextra2, string pextra3, string pextra4, string pextra5, string connstring)
    {
        DataSet ds1 = new DataSet();
        ...
        string[] parval = new string[10] { PPONo, irno, BillNumber, BillDate, BPID, pextra1, pextra2, pextra3, pextra4, pextra5 };
        string[] par = new string[10] { "@PPONo", "@PirNo", "@PbillNo", "@Pbildt", "@psuppcode","@pextra1","@pextra2","@pextra3", "@pextra4", "@pextra5" };
        ds1 = objconnectip.getDataAdapter("Pur_irndetail", "PUR_TaxCodes", parval, par, ConfigurationSettings.AppSettings["ConnectionType"].ToString());
